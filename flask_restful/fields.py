...
class DateTime(Raw):
    ...
    def format(self, value):
        try:
            ...
            elif self.dt_format == "blog_datetime":
                return _blog_datetime_format(value)
            elif self.dt_format == "blog_date":
                return _blog_date_format(value)
            else:
...
def _blog_datetime_format(dt):
    return dt.strftime("%Y-%m-%d %H:%M:%S")

def _blog_date_format(dt):
